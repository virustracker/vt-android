...
public class BleServer {
	...
	public static final UUID SERVICE_UUID = UUID.fromString("8C422626-0C6E-4B86-8EC7-9147B233D97E");
	public static final UUID TOTP_CHARACTERISTIC_UUID = UUID.fromString("A05F9DF4-9D54-4600-9224-983B75B9D154");
	...
	private BluetoothGattServerCallback createGattServerCallback() {
		return new BluetoothGattServerCallback() {
			...
			public void onCharacteristicReadRequest(BluetoothDevice device, int requestId, int offset,
				...
				// Temp change for startracing integration
				characteristic.setValue(VtApp.getModel().getNewAdvertiseTokenEvent().getTokenValueAsBase64());
