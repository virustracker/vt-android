...
import ch.ubique.android.starsdk.SyncWorker;
...
public class VtSTARTracing {
    ...
    public static void init(Context context, String appId) {
        if (ProcessUtil.isMainProcess(context)) {
            ch.virustracker.app.controller.startracing.VtSTARTracing.appId = appId;
    ...
    public static IntentFilter getUpdateIntentFilter() {
        IntentFilter intentFilter = new IntentFilter(ch.ubique.android.starsdk.STARTracing.UPDATE_INTENT_ACTION);
        return intentFilter;
    }
